...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->modifyModelsPath('/../Http/Controllers/MessageController.php','User');
        $this->modifyModelsPath('/../Http/Controllers/MessageController.php','ChFavorite');
        $this->modifyModelsPath('/../Http/Controllers/MessageController.php','ChMessage');
        $this->modifyModelsPath('/../Http/Controllers/Api/MessageController.php','User');
        $this->modifyModelsPath('/../Http/Controllers/Api/MessageController.php','ChFavorite');
        $this->modifyModelsPath('/../Http/Controllers/Api/MessageController.php','ChMessage');
