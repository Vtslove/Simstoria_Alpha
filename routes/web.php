...
Route::post('contact_us/accepted', ['as' => 'contact_us_accepted', 'uses' => 'HomeController@contactUsPost']);
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'auth'], function() {
    ...
    Route::group(['middleware' => 'admin'], function() {
        ...
        Route::group(['prefix'=>'settings'], function(){
            ...
            Route::post('other', ['as'=>'o', 'uses' => 'SettingsController@OtherSettingsPost']);
        });
    ...
    Route::group(['prefix'=>'account', 'middleware' => 'auth'], function() {
        Route::get('/', ['as' => 'account', 'uses' => 'AccountController@account']);
            });
    });

Route::get('team_create', ['as'=>'team_create', 'uses' => 'TeamCreateController@index']);
Route::post('team_create', ['uses' => 'TeamCreateController@']);
     Route::post('/Team/id', 'TeamController@allData')->name('contact-data');

/**
 *  Seacrh routes
 */

Route::get('/search_user', ['as'=>'search.results', 'uses' => 'SearchController@getResults']);

/**
 *  profiles routes
 */
Route::get('/user/{name}', ['as'=>'admin.profile', 'uses' => 'UserController@getProfile']);
...
Route::get('/contacts', [
    'uses' => 'ContactsController@getIndex',
    'as' => 'contacts',
    'middleware' => ['auth'],
]);
 ...
 */
Route::get('/test', [
   'uses' => 'TestController@myCampaigns',
   'as' => 'test',
]);
...
Route::get('/friends', ['as'=>'friends', 'uses' => 'FriendController@getIndex']);

Route::get('/friends/add/{name}', ['as'=>'friend.add', 'uses' => 'FriendController@getAdd', 'middleware' => ['auth'], ]);

Route::get('/friends/accept/{name}', ['as'=>'friend.accept', 'uses' => 'FriendController@getAccept', 'middleware' => ['auth'], ]);

Route::post('/friends/delete/{name}', ['as'=>'friend.delete', 'uses' => 'FriendController@postDelete', 'middleware' => ['auth'], ]);
/**
 * Messages
 */

Route::get('/messages', ['as'=>'messages', 'uses' => 'ChatController@index']);

Route::get('/contacts', ['as' => 'contacts', 'uses' => 'ContactsController@get']);

Route::get('/account', ['as'=>'profile', 'uses' => 'UserController@myCampaigns']);
