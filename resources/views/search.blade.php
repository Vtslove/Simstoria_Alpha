...
@section('content')
    ...
    <section class="home-campaign section-bg-white">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 class="section-title"> @lang('Team search results') </h2>
                </div>
            </div>
            ...
            <div class="row">
                ...
                @else
                    <div class="payment-received">
                        <h1><i class="fa fa-exclamation-triangle"></i> @lang('There is no teams to display')</h1>
                        <a href="{{route('browse_categories')}}" class="btn btn-lg-filled">@lang('Browse teams')</a>
                    </div>
                @endif
