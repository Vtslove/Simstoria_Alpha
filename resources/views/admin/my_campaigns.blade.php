            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    ...
                    @if( ! empty($title))
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header"> @lang('Project list')  </h1>
                            </div> <!-- /.col-lg-12 -->
                        </div> <!-- /.row -->
                    @endif
                            ...
                            @foreach($my_campaigns as $campaign)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('campaign_single', [$campaign->id, $campaign->slug])}}" class="btn btn-success btn-sm">info </a>
                                    </td>
                    ...
                    @else
                        <div class="alert alert-warning"><i class="fa fa-info-circle"></i> @lang('There is no projects to display') </div>
                    @endif
