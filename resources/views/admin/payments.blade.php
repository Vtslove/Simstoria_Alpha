            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    ...
                    @if( ! empty($title))
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header"> {{ $title }} <a class="btn pull-right" style="background-color: dimgrey;color: white" href="{{route('payments_pending')}}">@lang('app.pending_payments')</a> </h1>
                            </div> <!-- /.col-lg-12 -->
                        </div> <!-- /.row -->
                    @endif
