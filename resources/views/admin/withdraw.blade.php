            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    ...
                    @if( ! empty($title))
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header"> Withdraw (Under Working)

                                    <a href="{{route('withdrawal_preference')}}" class="btn pull-right" style="background-color: dimgrey;color: white"><i class="Withdrawal_icon"></i> @lang('app.withdrawal_preference')</a>
                                </h1>
