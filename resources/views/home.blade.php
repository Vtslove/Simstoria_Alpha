...
@section('content')
    ...
    <title> Simstoria | Home</title>

    <div class="main-page">
        <div class="container">
            <div class="row">

                <div class="welcome_block"><h1>Welcome to Simstoria</h1>
                <div>Try the new future of teams and company working
                    Create your own team or join to other</div></div>


                    <div class="jumbotron-button-wrap" style="margin-top: 25%">
                <a  class="btn btn-lg-outline"  href="{{route('browse_categories')}}">@lang('Check projects')</a>
                <a id="animate_button" class="btn btn-lg-filled" href="{{route('start_campaign')}}">@lang('Start a company')</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-footer">
                        <a href="{{route('browse_categories')}}" class="section-action-btn" style="border-color: darkorange;">@lang('app.see_all')</a>
                    </div>
                </div>
            </div>
