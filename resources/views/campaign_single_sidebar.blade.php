<div class="single-donate-wrap">
    ...
    <div style="margin-top: -10px;padding-bottom: 15px;" class="sidebar_buttons">
        <div style="background-color: darkorange;color: white;" href="#" class="btn btn-lg">Subscribe</div>
        <div style="color: darkorange;border-color: darkorange;" href="#" class="btn btn-lg">Join in team</div>
    </div>
    ...
    <div class="input-group">
        ...
        <div class="input-group-btn">
            <button style="color:white;background-color: darkorange" class="btn" id="campaign_url_copy_btn">@lang('app.copy_link')</button>
        </div>
    </div>
        ...
        @if( ! $is_ended)
            ...
            <form action="{{route('add_to_cart')}}" class="form-horizontal" method="post" > @csrf
                ...
                <div class="donate-form-button">
                    <button style="background-color: darkorange" type="submit" class="btn btn-block btn-lg">@lang('app.donate')</button>
                </div>
            </form>
